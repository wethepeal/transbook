...
| **M4** 双版本与审核回流 | 双语/纯中文渲染、`export-review`/`apply-review`、EPUB3、PDF 中文排版（A5） | ✅ **已完成大半**：EPUB3 + **Typst PDF**（351 页实测）+ 审核回流（`tp export-review`/`apply-review`）均可用；剩封面页与 epubcheck 校验 |
